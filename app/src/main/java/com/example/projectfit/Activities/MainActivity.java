...
public class MainActivity extends AppCompatActivity {
    ...
    private void addAllWorkouts() {
        List<Workout> workouts = Arrays.asList(
                new Workout("Push-Up", 10, "Strength", "A bodyweight exercise that strengthens the chest, triceps, and shoulders",
                        Arrays.asList("Chest", "Triceps", "Shoulders"), 80, null, null, null, Arrays.asList(3, 15), 2),
                ...
                new Workout("Bench Press", 15, "Strength", "A weightlifting exercise to build chest strength",
                ...
                new Workout("Skaters", 6, "Plyometrics", "A cardio exercise that also targets the legs and core",
                        Arrays.asList("Quads", "Glutes", "Core"), 90, null, null, null, Arrays.asList(3, 30), 3),
