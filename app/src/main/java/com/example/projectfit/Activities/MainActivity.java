        ...
        executor.execute(() -> {
            List<Workout> workouts = Arrays.asList(
                    ...
                    new Workout("Jump Rope", 15, "Calisthenics",
                            ...
                            Arrays.asList("Legs", "Core"), 200, R.drawable.jumpropesimage, Arrays.asList(1, 15), 1, R.drawable.jump_rope_thumbnail),

                    new Workout("Squats", 12, "Bodybuilding",
                            "Strengthens the lower body including the glutes, hamstrings, and quads",
                            Arrays.asList("Legs"), 100, R.drawable.squatimage, Arrays.asList(4, 12), 1, R.drawable.squats_thumbnail),

                    new Workout("Deadlift", 15, "Bodybuilding",
                            "A compound lift that strengthens the entire posterior chain",
                            Arrays.asList("Back", "Legs"), 150, R.drawable.deadliftimage, Arrays.asList(5, 8), 2, R.drawable.deadlift_thumbnail),

                    new Workout("Burpees", 8, "Calisthenics",
                            "A full-body exercise combining cardio and strength",
                            Arrays.asList("Legs", "Core"), 120, R.drawable.burpeeimage, Arrays.asList(3, 12), 4, R.drawable.burpees_thumbnail),

                    new Workout("Lunges", 10, "Bodybuilding",
                            "Great for targeting the glutes, quads, and hamstrings",
                            Arrays.asList("Legs"), 90, R.drawable.lunges, Arrays.asList(3, 12), 2, R.drawable.lunges_thumbnail),

                    new Workout("Plank", 5, "Calisthenics",
                            "Strengthens the core and improves overall stability",
                            Arrays.asList("Core", "Shoulders"), 40, R.drawable.plankimage, Arrays.asList(3, 1), 1, R.drawable.plank_thumbnail),

                    new Workout("Mountain Climbers", 8, "Calisthenics",
                            "Combines cardio and core strength",
                            Arrays.asList("Core", "Legs", "Shoulders"), 110, R.drawable.mountainclimbersimage, Arrays.asList(4, 30), 2, R.drawable.mountain_climbers_thumbnail),
                    ...
                    new Workout("Bicycle Crunch", 7, "Calisthenics",
                            ...
                            Arrays.asList("Abs", "Core"), 70, R.drawable.bicyclecrunchimage, Arrays.asList(4, 20), 1, R.drawable.bicycle_crunch_thumbnail),

                    new Workout("Russian Twists", 8, "Calisthenics",
                            "Strengthens the obliques and the core",
                            Arrays.asList("Abs", "Core"), 80, R.drawable.russiantwistsimage, Arrays.asList(3, 20), 1, R.drawable.russian_twists_thumbnail),
                    ...
                    new Workout("Cycling", 30, "Calisthenics",
                            ...
                            Arrays.asList("Legs"), 250, R.drawable.cyclingimage, Arrays.asList(1, 30), 2, R.drawable.cycling_thumbnail),

                    new Workout("Swimming", 30, "Calisthenics",
                            "A full-body workout that is great for endurance",
                            Arrays.asList("Legs", "Core", "Back"), 300, R.drawable.swimmingimage, Arrays.asList(1, 30), 3, R.drawable.swimming_thumbnail),

                    new Workout("Kettlebell Swings", 10, "Bodybuilding",
                            "Targets the hips and lower back while improving conditioning",
                            Arrays.asList("Lower Back", "Core"), 150, R.drawable.kettlebellswingimage, Arrays.asList(4, 15), 2, R.drawable.kettlebell_swings_thumbnail),

                    new Workout("Box Jumps", 6, "Calisthenics",
                            "A lower body explosive power workout",
                            Arrays.asList("Legs"), 120, R.drawable.boxjumpimage, Arrays.asList(3, 12), 3, R.drawable.box_jumps_thumbnail),

                    new Workout("Wall Sit", 5, "Calisthenics",
                            "Builds endurance in the quads and core",
                            Arrays.asList("Legs", "Core"), 40, R.drawable.wallsitimage, Arrays.asList(3, 1), 1, R.drawable.wall_sit_thumbnail),
                    ...
                    new Workout("Farmer’s Walk", 8, "Bodybuilding",
                            ...
                            Arrays.asList("Core", "Shoulders"), 100, R.drawable.farmerswalkimage, Arrays.asList(3, 60), 2, R.drawable.farmers_walk_thumbnail),
                    ...
                    new Workout("Leg Press", 12, "Bodybuilding",
                            ...
                            Arrays.asList("Legs"), 120, R.drawable.legpressimage, Arrays.asList(4, 10), 2, R.drawable.leg_press_thumbnail),

                    new Workout("Overhead Press", 10, "Bodybuilding",
                            "Strengthens the shoulders and upper chest",
                            Arrays.asList("Shoulders"), 90, R.drawable.overheadpressimage, Arrays.asList(3, 10), 3, R.drawable.overhead_press_thumbnail),
                    ...
                    new Workout("Glute Bridge", 8, "Bodybuilding",
                            ...
                            Arrays.asList("Core"), 60, R.drawable.glutesbridgeimage, Arrays.asList(3, 15), 2, R.drawable.glute_bridge_thumbnail),
                    ...
                    new Workout("Full-Body Circuit", 60, "Calisthenics",
                            ...
                            Arrays.asList("Full Body", "Legs", "Core"), 600, R.drawable.fullcircuitimage, Arrays.asList(4, 12), 3, R.drawable.full_body_circuit_thumbnail),
                    ...
                    new Workout("Functional Training", 60, "Bodybuilding",
                            ...
                            Arrays.asList("Full Body", "Legs", "Core"), 550, R.drawable.functionaltrainingimage, Arrays.asList(4, 15), 3, R.drawable.functional_training_thumbnail),
                    ...
                    new Workout("HIIT Full Body", 60, "Calisthenics",
                            ...
                            Arrays.asList("Full Body", "Core"), 650, R.drawable.hiitimage, Arrays.asList(5, 10), 3, R.drawable.hiit_full_body_thumbnail),
                    ...
                    new Workout("Endurance Full Body", 90, "Calisthenics",
                            ...
                            Arrays.asList("Full Body", "Legs", "Core"), 900, R.drawable.endurancimage, Arrays.asList(5, 15), 3, R.drawable.endurance_full_body_thumbnail),
                    ...
                    new Workout("Advanced Strength Full Body", 90, "Bodybuilding",
                            ...
                            Arrays.asList("Full Body", "Legs", "Core"), 850, R.drawable.advancedfullbodyimage, Arrays.asList(4, 10), 3, R.drawable.advanced_strength_full_body_thumbnail),
                    ...
                    new Workout("Full Body Yoga and Strength", 90, "Mobility",
                            ...
                            Arrays.asList("Full Body", "Legs", "Core"), 800, R.drawable.yogastrengthimage, Arrays.asList(6, 12), 2, R.drawable.full_body_yoga_and_strength_thumbnail)
            );
